...
public class CalculadoraTeste {
    ...
    /**
     * Teste comum, o método assertEquals realiza a operação de teste de
     * igualdade.
     */
    @Test
    ...
    /**
     * Teste para números de ponto flutuante. Destaque para o terceiro
     * parâmetro, o delta, que define qual a diferença decimal entre cada
     * parâmetro. O propósito do parâmetro delta desse método é determinar o
     * valor máximo da diferença entre os números expected e actual para que
     * eles sejam considerados o mesmo valor.
     */
    @Test
    ...
    /**
     * Teste para exceções Se não disparar a exceção, o método falha.
     */
    @Test
